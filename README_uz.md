...
* Kompyuter Tuzilishi va Dizayni ---- Computer Organization and Design
	* [MIPS nashri ---- MIPS Edition](https://www.amazon.ca/Computer-Organization-Design-MIPS-Interface/dp/0124077269/)
	* [ARM nashri ---- ARM Edition](https://www.amazon.ca/Computer-Organization-Design-ARM-Interface/dp/0128017333/)
	* [RISC-V nashri ---- RISC-V Edition](https://www.amazon.com/Computer-Organization-Design-RISC-V-Architecture/dp/0128122757)
...
* [Parallel dasturlash Qiyinmi? Agar shunday bo'lsa, unda u borada Siz nima qila olasiz?  ----  Is Parallel Programming Hard, And, If So, What Can You Do About It?](https://www.kernel.org/pub/linux/kernel/people/paulmck/perfbook/perfbook.html)
...
* [C'da Freymvork va plagin dizayni  ----  Framework and plugin design in C](https://github.com/gurugio/book_cprogramming)
	...
	* Linux kerneli manda kodini o'qish bo'yicha judayam boshlang'ich dasturlash maslahatlari (programming tips)
...
Misol uchun, Raspberry Pi platasi 64-bit instruksiya to'plamini (instruction set) qo'llab-quvvatlovchi Cortex-A53 Protsessoriga ega.
...
* Boshqa resurslar: Men tavsiya qiladigan bepul manbalar
	...
	* Linux kernel va Raspberry Pi ishlatgan holda OS yasash  ----  [Learning operating system development using Linux kernel and Raspberry Pi](https://github.com/s-matyukevich/raspberry-pi-os)
		...
		* Men har doim ishonamanki, Linux kerneliga o'xsash kernelni yasab ko'rish Linux kernelini tushunishning eng zo'r yo'li.
...
Menda bu tatbiqlar bo'yicha hech qanday bilim yo'q. Iltimos, menga yangi boshlovchilarga mo'ljallangan har qanday ma'lumotni jo'nating.
...
ARM, Samsumng va boshqa kompaniyalar o'zining real-vaqtda ishlaydigan OS'ga (real-time OS) ega. Ammo, afsuski, ularning ko'pi yopiq manbali.
...
- C bilan biror amaliy (practical) narsa qiling
	...
	- [leetcode.com](https://leetcode.com/): agarda Siz biror qiziq loyiha topolmasangiz, unda ma'lumotlar tuzilmalari va algoritmlarga e'tiborni qaratgan (focus) yaxshi.
- Birorta Hardware loyiha qiling
	...
	- Mening tavsiyam shuki, ATmega128 to'plamini sotib oling va LEDlarni yoqib/o'chirishga, svitch kiritishini (input) aniqlashga va LCD displeyiga habar chiqarishga firmware yasang. Motorni boshqaradigan dastur ham juda yaxshi loyiha: masalan, chiziq bo'ylab harakatlnauvchi (the line tracer).
